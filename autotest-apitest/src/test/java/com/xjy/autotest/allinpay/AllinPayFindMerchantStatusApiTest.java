 ...
 */
public class AllinPayFindMerchantStatusApiTest extends OpenapiTestBasis{

	@AutoTest(file = "allinpay/allinPayFindMerchantStatusApiTestSuccess.csv")
	@DisplayName("通联查询进件状态--成功用例")
	public void allinPayFindMerchantStatusApiTestSuccess(
			int testId,
			String status,
			String code,
			// 基本参数
		...
		//初始化数据
		service = "allinPayFindMerchantStatus";
		partnerId = pId;
		...
		//结果验证
    	print("通联查询进件状态response:" + response.toString());
