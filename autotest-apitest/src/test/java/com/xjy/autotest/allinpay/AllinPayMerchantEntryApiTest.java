 ...
 */
public class AllinPayMerchantEntryApiTest extends OpenapiTestBasis {

    @AutoTest(file = "allinpay/allinPayMerchantEntryApiTestSuccess.csv")
    @DisplayName("通联进件--成功用例")
    public void allinPayMerchantEntryApiTestSuccess(
            int testId,
            String status,
            String code,
            // 基本参数
        ...
        //初始化数据
        service = "allinPayMerchantEntry";
        partnerId = pId;
        securityCheckCode = secretKey;
        merchantOrderNo = "merchantOrderNo" + System.currentTimeMillis();

        //subMerchantProperty = "NATURAL_PERSON";
        subMerchantProperty = "ENTERPRISE_LEGAL_PERSON";
        //清除数据
        //准备数据
        //测试过程
        //主订单
        ...
        dataMap.put("subMerchantProperty", subMerchantProperty);//[会员类型](通联只能选 ENTERPRISE_LEGAL_PERSON-企业会员,NATURAL_PERSON-个人会员)
        //签名
        ...
        //结果验证
        print("通联进件response:" + response.toString());
