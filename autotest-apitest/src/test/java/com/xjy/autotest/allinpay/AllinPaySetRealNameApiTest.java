 ...
 */
public class AllinPaySetRealNameApiTest extends OpenapiTestBasis {

    @AutoTest(file = "allinpay/allinPaySetRealNameApiTestSuccess.csv")
    @DisplayName("通联个人会员实名认证--成功用例")
    public void allinPaySetRealNameApiTestSuccess(
            int testId,
            String status,
            String code,
            // 基本参数
        ...
        //初始化数据
        service = "allinPaySetRealName";
        partnerId = pId;
        securityCheckCode = secretKey;
        merchantOrderNo = "merchantOrderNo" + System.currentTimeMillis();
        //merchantOrderNo = "merchantOrderNo1564986663558";

        certType = "IDENTITY_CARD";
        certNo = "500235198510107998";
        realName = "于朝洋";
        //清除数据
        //准备数据
        //测试过程
        ...
        dataMap.put("certNo", certNo);//证件号码
        ...
        //结果验证
        print("通联个人会员实名认证response:" + response.toString());
