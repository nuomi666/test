 ...
 */
public class FindMerchantBindBankCardApiTest extends OpenapiTestBasis {

	@AutoTest(file = "allinpay/findMerchantBindBankCardApiTestSuccess.csv")
	@DisplayName("查询绑定银行卡--成功用例")
	public void findMerchantBindBankCardApiTestSuccess(
			int testId,
			String status,
			String code,
			// 基本参数
		...
		//初始化数据
		service = "findMerchantBindBankCard";
		partnerId = pId;
		...
		//结果验证
    	print("查询绑定银行卡response:" + response.toString());
