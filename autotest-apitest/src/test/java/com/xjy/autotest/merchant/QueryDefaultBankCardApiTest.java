 ...
 */
public class QueryDefaultBankCardApiTest extends OpenapiTestBasis{

	@AutoTest(file = "merchant/queryDefaultBankCardApiTestSuccess.csv")
	@DisplayName("查询默认绑定的银行卡--成功用例")
	public void queryDefaultBankCardApiTestSuccess(
			int testId,
			String status,
			String code,
			// 基本参数
		...
		//结果验证
    	print("查询默认绑定的银行卡response:" + response.toString());
