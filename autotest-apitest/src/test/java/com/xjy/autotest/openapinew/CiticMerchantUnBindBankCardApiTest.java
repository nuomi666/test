 ...
 */
public class CiticMerchantUnBindBankCardApiTest extends OpenapiTestBasis {

    @AutoTest(file = "openapinew/citicMerchantUnBindBankCardApiTestSuccess.csv")
    @DisplayName("电商管家解绑卡--成功用例")
    public void citicMerchantUnBindBankCardApiTestSuccess(
            int testId,
            String status,
            String code,
            // 基本参数
        ...
        //初始化数据
        service = "citicMerchantUnBindBankCard";
        partnerId = pId;
        ...
        //结果验证
        print("电商管家解绑卡response:" + response.toString());
