 ...
 */
public class PayChannelListApiTest extends OpenapiTestBasis {

	@AutoTest(file = "openapinew/payChannelListApiTestSuccess.csv")
	@DisplayName("支付渠道列表--成功用例")
	public void payChannelListApiTestSuccess(
			int testId,
			String status,
			String code,
			// 基本参数
		...
		//初始化数据
		service = "payChannelList";
		partnerId = pId;
		//partnerId = "S0301808271500000065";
		...
		//dataMap.put("payChannel", payChannel);//收单机构
		//dataMap.put("payType", payType);//支付方式
        //签名
		...
		//结果验证
    	print("支付渠道列表response:" + response.toString());
