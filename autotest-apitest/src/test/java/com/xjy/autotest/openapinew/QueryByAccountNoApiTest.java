 ...
 */
public class QueryByAccountNoApiTest extends OpenapiTestBasis {

	@AutoTest(file = "openapinew/queryByAccountNoApiTestSuccess.csv")
	@DisplayName("查询账户信息--成功用例")
	public void queryByAccountNoApiTestSuccess(
			int testId,
			String status,
			String code,
			// 基本参数
		...
		//结果验证
    	print("查询账户信息response:" + response.getBody());
