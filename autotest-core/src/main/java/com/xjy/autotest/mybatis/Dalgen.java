...
public class Dalgen {
    ...
    public void gen(String projectName) {
        ...
        try {
            ...
            String name = tarProject.replace("apitest", "core")
                    .replace("webtest", "core")
                    .replace("paycore", "core")
                    .replace("apitest", "core")
                    .replace("gas", "core")
                    .replace("shell", "core");
            ...
            String nameResource = resourceName.replace("apitest", "core")
                    .replace("webtest", "core")
                    .replace("paycore", "core")
                    .replace("apitest", "core")
                    .replace("gas", "core")
            ...
            pluginConfiguration.setConfigurationType("com.xjy.autotest.mybatis.ToStringPlugin");
            ...
            pluginConfiguration3.setConfigurationType("com.xjy.autotest.mybatis.RenameExampleClassPlugin");
            ...
            pluginConfiguration4.addProperty("mappers", "com.xjy.autotest.annotation.MyMapper");
