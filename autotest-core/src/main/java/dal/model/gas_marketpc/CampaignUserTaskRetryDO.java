...
@Table(name = "campaign_user_task_retry")
public class CampaignUserTaskRetryDO implements Serializable {
    @Id
    ...
    public boolean equals(Object that) {
        ...
        CampaignUserTaskRetryDO other = (CampaignUserTaskRetryDO) that;
