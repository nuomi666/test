...
@Table(name = "give_coupon_detail")
public class GiveCouponDetailDO implements Serializable {
    @Id
     ...
     * 业务流水号
     */
    @Column(name = "biz_instruction_id")
    private String bizInstructionId;
     ...
     * 获取业务流水号
     *
     * @return biz_instruction_id - 业务流水号
     */
    public String getBizInstructionId() {
        return bizInstructionId;
    }

    /**
     * 设置业务流水号
     *
     * @param bizInstructionId 业务流水号
     */
    public void setBizInstructionId(String bizInstructionId) {
        this.bizInstructionId = bizInstructionId == null ? null : bizInstructionId.trim();
    }
     ...
     * 设置赠送的优惠券
     *
     * @param couponInfos 赠送的优惠券
     */
    public void setCouponInfos(String couponInfos) {
        this.couponInfos = couponInfos == null ? null : couponInfos.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", bizInstructionId=").append(bizInstructionId);
        ...
        sb.append(", couponInfos=").append(couponInfos);
    ...
    public boolean equals(Object that) {
        ...
        GiveCouponDetailDO other = (GiveCouponDetailDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getEventId() == null ? other.getEventId() == null : this.getEventId().equals(other.getEventId()))
            && (this.getGiveBizNo() == null ? other.getGiveBizNo() == null : this.getGiveBizNo().equals(other.getGiveBizNo()))
            && (this.getBizInstructionId() == null ? other.getBizInstructionId() == null : this.getBizInstructionId().equals(other.getBizInstructionId()))
            ...
            && (this.getCouponInfos() == null ? other.getCouponInfos() == null : this.getCouponInfos().equals(other.getCouponInfos()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBizInstructionId() == null) ? 0 : getBizInstructionId().hashCode());
        ...
        result = prime * result + ((getCouponInfos() == null) ? 0 : getCouponInfos().hashCode());
