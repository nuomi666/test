...
@Table(name = "give_luck_draw_detail")
public class GiveLuckDrawDetailDO implements Serializable {
    @Id
    ...
    public void setPrizePoolId(String prizePoolId) {
        this.prizePoolId = prizePoolId == null ? null : prizePoolId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", prizePoolId=").append(prizePoolId);
    ...
    public boolean equals(Object that) {
        ...
        GiveLuckDrawDetailDO other = (GiveLuckDrawDetailDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPrizePoolId() == null ? other.getPrizePoolId() == null : this.getPrizePoolId().equals(other.getPrizePoolId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPrizePoolId() == null) ? 0 : getPrizePoolId().hashCode());
