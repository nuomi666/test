...
@Table(name = "gas_login_log_copy")
public class GasLoginLogCopyDO implements Serializable {
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasLoginLogCopyDO other = (GasLoginLogCopyDO) that;
