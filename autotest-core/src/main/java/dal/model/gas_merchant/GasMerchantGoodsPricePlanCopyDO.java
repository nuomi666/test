...
@Table(name = "gas_merchant_goods_price_plan_copy")
public class GasMerchantGoodsPricePlanCopyDO implements Serializable {
    /**
     * id
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasMerchantGoodsPricePlanCopyDO other = (GasMerchantGoodsPricePlanCopyDO) that;
