...
public class GasMerchantSourceDataDO implements Serializable {
    ...
    private Date authorizerAccessTokenTime;
     ...
     * 获取授权令牌入库时间
     *
     * @return authorizer_access_token_time - 授权令牌入库时间
     */
     ...
     * 设置授权令牌入库时间
     *
     * @param authorizerAccessTokenTime 授权令牌入库时间
     */
     ...
     * 获取授权令牌
     *
     * @return authorizer_access_token - 授权令牌
     */
     ...
     * 设置授权令牌
     *
     * @param authorizerAccessToken 授权令牌
     */
