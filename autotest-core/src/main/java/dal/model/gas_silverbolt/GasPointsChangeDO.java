...
@Table(name = "gas_points_change")
public class GasPointsChangeDO implements Serializable {
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasPointsChangeDO other = (GasPointsChangeDO) that;
