...
@Table(name = "wash_sales_campaign")
public class WashSalesCampaignDO implements Serializable {
    @Id
     ...
     * 是否限制适用油站
     */
    @Column(name = "limit_station")
    private Byte limitStation;
     ...
     * 获取是否限制适用油站
     *
     * @return limit_station - 是否限制适用油站
     */
    public Byte getLimitStation() {
        return limitStation;
    }
     ...
     * 设置是否限制适用油站
     *
     * @param limitStation 是否限制适用油站
     */
    public void setLimitStation(Byte limitStation) {
    ...
    public String toString() {
        ...
        sb.append(", limitStation=").append(limitStation);
    ...
    public boolean equals(Object that) {
        ...
        WashSalesCampaignDO other = (WashSalesCampaignDO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLimitStation() == null ? other.getLimitStation() == null : this.getLimitStation().equals(other.getLimitStation()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLimitStation() == null) ? 0 : getLimitStation().hashCode());
