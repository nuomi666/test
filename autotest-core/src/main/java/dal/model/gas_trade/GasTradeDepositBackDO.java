...
@Table(name = "gas_trade_deposit_back")
public class GasTradeDepositBackDO implements Serializable {
    /**
     * 自增序列
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        GasTradeDepositBackDO other = (GasTradeDepositBackDO) that;
