...
@Table(name = "user_change_message_task")
public class UserChangeMessageTaskDO implements Serializable {
    @Id
    ...
    public boolean equals(Object that) {
        ...
        UserChangeMessageTaskDO other = (UserChangeMessageTaskDO) that;
