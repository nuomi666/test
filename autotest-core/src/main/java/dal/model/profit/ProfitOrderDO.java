...
@Table(name = "profit_order")
public class ProfitOrderDO implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        ProfitOrderDO other = (ProfitOrderDO) that;
