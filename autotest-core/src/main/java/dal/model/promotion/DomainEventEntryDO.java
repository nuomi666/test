...
public class DomainEventEntryDO implements Serializable {
    @Id
    ...
    public String toString() {
        ...
        sb.append(" [");
        sb.append(", globalIndex=").append(globalIndex);
    ...
    public boolean equals(Object that) {
        ...
        DomainEventEntryDO other = (DomainEventEntryDO) that;
        return (this.getGlobalIndex() == null ? other.getGlobalIndex() == null : this.getGlobalIndex().equals(other.getGlobalIndex()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getGlobalIndex() == null) ? 0 : getGlobalIndex().hashCode());
