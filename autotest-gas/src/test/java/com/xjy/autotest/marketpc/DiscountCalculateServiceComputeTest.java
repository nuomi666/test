...
//import com.xyb.gas.marketpc.api.trans.order.DiscountOrder;
...
// * @date 2018/12/26
// */
//public class DiscountCalculateServiceComputeTest extends SpringBootTestBase {
...
//     * 1001
//     */
//    @AutoTest(file = "marketpc/discountCalculateServiceComputeTestSuccess.csv")
//    @DisplayName("计算优惠--成功用例")
//    public void discountCalculateServiceComputeTestSuccess(
//            // 基本参数
//            int testId,
//            Status status,
//            String code,
...
//        couponIds.add("001ikzpdyozks107pr00");
//        //油品信息
//        order.setGasInfo(gasInfo);
//        //商品列表信息
//        order.setGoods(goods);
//        //优惠券
//        if(testId==1002) {//使用优惠券
...
//        // 调用接口
//        CalculateDiscountResult result = discountCalculateService.compute(order);
//        // 结果验证
//        print(result);
